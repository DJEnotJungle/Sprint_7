...
public class CourierLoginTest {
    ...
    public void testLoginCourierIdeal(){
        ...
        ValidatableResponse response1 = courierSteps.courierLogin(courierLogin);
        response1.assertThat().body("id", greaterThan(0)).and().statusCode(200);
    ...
    public void testLoginCourierWithoutCreating(){
        ValidatableResponse response1 = courierSteps.courierLogin(courierLogin);
        response1.assertThat().body("message", equalTo("Учетная запись не найдена")).and().statusCode(404);
    }
    ...
    public void testLoginCourierWithoutPassword(){
        ValidatableResponse response = courierSteps.courierCreate(courier);
        ValidatableResponse response1 = courierSteps.courierLogin(courierLoginWithOutPassword);
        response1.assertThat().body("message", equalTo("Недостаточно данных для входа")).and().statusCode(400);
        id=courierSteps.courierGetId(courierLogin).extract().path("id");
    }
    ...
    public void testLoginCourierWithoutLogin(){
        ValidatableResponse response = courierSteps.courierCreate(courier);
        ValidatableResponse response1 = courierSteps.courierLogin(courierLoginWithOutLogin);
        response1.assertThat().body("message", equalTo("Недостаточно данных для входа")).and().statusCode(400);
        id=courierSteps.courierGetId(courierLogin).extract().path("id");
    }
    ...
    public void testLoginCourierWithErrorLogin(){
        ValidatableResponse response = courierSteps.courierCreate(courier);
        ValidatableResponse response1 = courierSteps.courierLogin(courierLoginWithErrorLogin);
        response1.assertThat().body("message", equalTo("Учетная запись не найдена")).and().statusCode(404);
        id=courierSteps.courierGetId(courierLogin).extract().path("id");
    }
    ...
    public void testLoginCourierWithErrorPassword(){
        ValidatableResponse response = courierSteps.courierCreate(courier);
        ValidatableResponse response1 = courierSteps.courierLogin(courierLoginWithErrorPassword);
        response1.assertThat().body("message", equalTo("Учетная запись не найдена")).and().statusCode(404);
        id=courierSteps.courierGetId(courierLogin).extract().path("id");
    }
